...
for items in n:
    ...
    average_file_name = sampling_location + str(i)
    fil=open( os.path.join('Backup',average_file_name),'a') # opening a file to store the averaged samples , in the backup directory now
